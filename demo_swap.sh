...
#          --image_origin "./examples/swap/7/7.png" \
#          --image "./examples/swap/7/7_dog.jpg" \
#          --pnp --t5_cpu --dit_fsdp --ulysses_size 2 \
#          --pnp_layers 27 29 31 32\
#          --injection_step 0.5 \
#          --prompt_origin "" \
#          --prompt "A man in casual attire, including a black t-shirt, blue jeans, and sneakers, is seen walking on a paved path in a park with his Samoyed guide dog." \
#          --sample_solver "fm_new" \
#          --sample_steps 51 \
#          --offload_model 'True' \
#          --load_intermediate_latent_path "../Wan2.1/latents_swap/7.pt"\
...
torchrun --nproc_per_node=2 --master_port 11245 generate.py \
         ...
         --size 832*480 \
         --ckpt_dir ../Wan2.1-I2V-14B-480P \
         --image_origin "./examples/swap/9/9.png" \
         --image "./examples/swap/9/9_tower.jpg" \
         --pnp --t5_cpu --dit_fsdp --ulysses_size 2 \
         --pnp_layers 27 29 31 32\
         --injection_step 0.5 \
         --prompt_origin "" \
         --prompt "A colossal Eiffel Tower stands atop a white base with classical columns, surrounded by a dense forest." \
         --sample_solver "fm_new" \
         --sample_steps 51 \
         --offload_model 'True' \
         --load_intermediate_latent_path "../Wan2.1/latents_swap/9.pt"\
         --load_intermediate_latent_t 995.9473266601562 \
         --sample_guide_scale 3.0
